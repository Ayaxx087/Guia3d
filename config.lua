...
-- Set 0 to disable
kills_per_day_red_skull = 12
kills_per_week_red_skull = 84
kills_per_month_red_skull = 360

-- How many players you need to kill to gain a black skull per day/week/month
-- Set 0 to disable
kills_per_day_black_skull = 21
kills_per_week_black_skull = 147
kills_per_month_black_skull = 630
