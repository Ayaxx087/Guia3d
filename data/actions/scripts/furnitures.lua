...
function onUse(cid, item, frompos, item2, topos)
	 ...
	 if doPlayerRemoveMoney(cid, 500) == 1 then 
		...
		doPlayerSendCancel(cid, "You dont have enough money, you need 500 gp.")
	 ...
	 if doPlayerRemoveMoney(cid, 250) == 1 then 
		...
		doPlayerSendCancel(cid, "You dont have enough money, you need 250 gp.")
	 ...
	 if doPlayerRemoveMoney(cid, 400) == 1 then 
		...
		doPlayerSendCancel(cid, "You dont have enough money, you need 400 gp.")
	 ...
	 if doPlayerRemoveMoney(cid, 50) == 1 then 
		...
		doPlayerSendCancel(cid, "You dont have enough money, you need 50 gp.")
	 ...
	 if doPlayerRemoveMoney(cid, 0) == 1 then 
		...
		doPlayerSendCancel(cid, "You dont have enough money, you need xx gp.")
	 ...
	 if doPlayerRemoveMoney(cid, 1100) == 1 then 
		...
		doPlayerSendCancel(cid, "You dont have enough money, you need 1100 gp.")
	 ...
	 if doPlayerRemoveMoney(cid, 600) == 1 then 
		...
		doPlayerSendCancel(cid, "You dont have enough money, you need 600 gp.")
	 ...
	 if doPlayerRemoveMoney(cid, 1500) == 1 then 
		...
		doPlayerSendCancel(cid, "You dont have enough money, you need 1500 gp.")
	 ...
	 if doPlayerRemoveMoney(cid, 700) == 1 then 
		...
		doPlayerSendCancel(cid, "You dont have enough money, you need 700 gp.")
	 ...
	 if doPlayerRemoveMoney(cid, 25) == 1 then 
		...
		doPlayerSendCancel(cid, "You dont have enough money, you need 25 gp.")
	 ...
	 if doPlayerRemoveMoney(cid, 800) == 1 then 
		...
		doPlayerSendCancel(cid, "You dont have enough money, you need 800 gp.")
	 ...
	 if doPlayerRemoveMoney(cid, 1200) == 1 then 
		...
		doPlayerSendCancel(cid, "You dont have enough money, you need 1200 gp.")
	 ...
	 if doPlayerRemoveMoney(cid, 75) == 1 then 
		...
		doPlayerSendCancel(cid, "You dont have enough money, you need 75 gp.")
	 ...
	 if doPlayerRemoveMoney(cid, 350) == 1 then 
		...
		doPlayerSendCancel(cid, "You dont have enough money, you need 350 gp.")
