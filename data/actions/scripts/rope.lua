...
--hole or stair to rope items--
	...
	elseif item2.itemid == 469 or item2.itemid == 462 or item2.itemid == 470 or item2.itemid == 475 or item2.itemid == 476 or
	 ...
	 item2.itemid == 433 or item2.itemid == 3135 or item2.itemid == 3136 or item2.itemid == 3137 or
         item2.itemid == 4835 or item2.itemid == 4837 or item2.itemid == 5081 then
		npos.y = npos.y + 1
