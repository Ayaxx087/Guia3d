local tasks =
{
	[1] = {questStarted = 1510, questStorage = 65000, killsRequired = 100, raceName = "Trolls", rewards = {{enable = true, type = "exp", values = 20000}, {enable = true, type = "money", values = 20000}}},
	[2] = {questStarted = 1511, questStorage = 65001, killsRequired = 150, raceName = "Goblins", rewards = {{enable = true, type = "exp", values = 30000}, {enable = true, type = "money", values = 25000}}},
	[3] = {questStarted = 1512, questStorage = 65002, killsRequired = 300, raceName = "Rotworms", rewards = {{enable = true, type = "exp", values = 100000}, {enable = true, type = "money", values = 40000}}},
	[4] = {questStarted = 1513, questStorage = 65003, killsRequired = 500, raceName = "Cyclops", rewards = {{enable = true, type = "exp", values = 300000}, {enable = true, type = "money", values = 80000}}},
	[5] = {questStarted = 1514, questStorage = 65004, killsRequired = 300, raceName = "Crocodiles", rewards = {{enable = true, type = "exp", values = 80000}, {enable = true, type = "money", values = 40000}}},
	[6] = {questStarted = 1515, questStorage = 65005, killsRequired = 300, raceName = "Tarantulas", rewards = {{enable = true, type = "exp", values = 90000}, {enable = true, type = "money", values = 50000}}},
	[7] = {questStarted = 1516, questStorage = 65006, killsRequired = 150, raceName = "Carniphilas", rewards = {{enable = true, type = "exp", values = 95000}, {enable = true, type = "money", values = 55000}}},
	[8] = {questStarted = 1517, questStorage = 65007, killsRequired = 200, raceName = "Stone Golems", rewards = {{enable = true, type = "exp", values = 100000}, {enable = true, type = "money", values = 60000}}},
	[9] = {questStarted = 1518, questStorage = 65008, killsRequired = 500, raceName = "Giant Spiders", rewards = {{enable = true, type = "exp", values = 500000}, {enable = true, type = "money", values = 300000}}},
	[10] = {questStarted = 1519, questStorage = 65009, killsRequired = 2000, raceName = "Hydras", rewards = {{enable = true, type = "exp", values = 800000}, {enable = true, type = "money", values = 500000}}},
	[11] = {questStarted = 1520, questStorage = 65010, killsRequired = 2000, raceName = "Behemoths", rewards = {{enable = true, type = "exp", values = 1000000}, {enable = true, type = "money", values = 800000}}},
	[12] = {questStarted = 1521, questStorage = 65011, killsRequired = 1500, raceName = "Serpents Spawn", rewards = {{enable = true, type = "exp", values = 500000}, {enable = true, type = "money", values = 300000}}},
	[13] = {questStarted = 1522, questStorage = 65012, killsRequired = 500, raceName = "Green Djinns", rewards = {{enable = true, type = "exp", values = 1000000}, {enable = true, type = "money", values = 300000}}},
